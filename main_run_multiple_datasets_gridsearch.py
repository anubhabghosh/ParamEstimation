...
def main():
    ...
    for i, params in enumerate(params_combination_list):
        ...
        flag_log_dir, flag_json_file = check_if_dir_or_file_exists(list_of_logfile_paths[i],
        ...
        print("Is json-file present:? - {}".format(flag_json_file))
        ...
        json_file_path = os.path.join(list_of_logfile_paths[i], json_file_name)
