...
from utils.data_utils import Series_Dataset, obtain_tr_val_test_idx, check_if_dir_or_file_exists, load_splits_file
from utils.data_utils import get_dataloaders, load_saved_dataset, NDArrayEncoder, create_splits_file_name
...
def main():
    ...
    usage = "use an RNN for parameter estimation using trajectories of non-linear models \n"\
        "python main_for_var_estimate.py --mode [train/test] --model_type [gru/lstm] --dataset_mode [pfixed/vars/all] \n"\
        "--datafile [fullpath to datafile] --use_norm 0 --splits [fullpath to splits file]"
