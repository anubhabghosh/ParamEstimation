...
for mi=1:M
    ...
    % Get the prediction
    predicted_theta_mi = evaluate_using_NLSS_fixed_theta_simpler_model_random_init(transpose(y_mi), ...
                                                                                    sampled_theta_mi, N); 
...
save('results_ML_fixed_theta_simpler_altmodel_random_init.mat', 'res');
