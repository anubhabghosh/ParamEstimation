function [mse_pred_actual, mse_pred_asymp, predicted_theta, asymp_theta_analytical, actual_theta] = compute_test_mse_fixed_theta_with_bias(d, M, p, N, Phi, Y, actual_theta, lambda_e)
    ...
    asymp_theta_analytical = compute_asymptotic_theta(d, p, N, theta_i, Phi, Y, mu_theta, var_theta);
    ...
    mse_pred_asymp = immse(predicted_theta, asymp_theta_analytical);
