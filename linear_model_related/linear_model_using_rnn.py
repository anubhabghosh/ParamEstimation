...
from data_utils_linear_model import generate_trajectory_param_pairs, Series_Dataset, obtain_tr_val_test_idx
from data_utils_linear_model import get_dataloaders
from plot_utils import plot_trajectories, plot_losses
import pickle as pkl 
import os
import torch
import json
from models_linear import RNN_model, train_rnn, evaluate_rnn
import argparse
...
def main():
    ...
    if usenorm_flag == 1:
        datafile = "./data/trajectories_lm_data_normalized.pkl"
    else:
        datafile = "./data/trajectories_lm_data.pkl"
    ...
    #model_type = "gru"
    with open("configurations_lm.json") as f:
        options = json.load(f)
